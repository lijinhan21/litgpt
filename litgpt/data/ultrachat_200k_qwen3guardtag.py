...
@dataclass
class UltraChat_200k_qwen3guardtag(DataModule):
    ...
    repo_id: str = "/mnt/cephfs/safe_cot_pt/data/MaxLen100ultrachat200k_MaxLen_Qwen3Guard"
...
def format_dataset(dataset_partition: dict, include_multi_turn_conversations: bool) -> List[dict]:
    ...
    for entry in dataset_partition:
        ...
        if include_multi_turn_conversations:
            ...
            formatted_ds.append({"instruction": convo[0]['content'], "input": "", "output": entry["processed_text"]})
