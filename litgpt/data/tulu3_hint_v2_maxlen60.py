...
@dataclass
class Tulu3_hint_v2_maxlen60(DataModule):
    ...
    repo_id: str = "/mnt/nodessd/n95/lijinhan/safe_cot_pt/data/tulu3_hint_v2_maxlen60/final_dataset_merged_classified" 
...
if __name__ == '__main__':
    data_path = '/mnt/nodessd/n95/lijinhan/safe_cot_pt/data/tulu3_hint_v2_maxlen60/final_dataset_merged_classified'
    from datasets import load_dataset, load_from_disk
