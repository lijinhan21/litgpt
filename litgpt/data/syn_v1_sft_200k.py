...
@dataclass
class Syn_v1_sft_200k(DataModule):
    """Syn_v1_sft_200k data module for supervised finetuning."""
    ...
    repo_id: str = "/mnt/cephfs/lijinhan/workspace/AlignmentGap/outputs_20k_pair/sft_data.json" #"/mnt/cephfs/lijinhan/workspace/AlignmentGap/outputs_20k_30temp_aug_big/sft_data.json" 
