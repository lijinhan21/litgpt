...
@dataclass
class Tulu3_en_nosafe_prompt(DataModule):
    ...
    for entry in dataset:
        ...
        if include_multi_turn_conversations:
            ...
            for i in range(num):
                ...
                output = part2 + ' ' + entry['processed_text'][i]
                # delete all Safe tags
                output = output.replace('<think> Safe </think>', '')
                formatted_ds.append({"instruction": part1, "input": "", "output": output})
