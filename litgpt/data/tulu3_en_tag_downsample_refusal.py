...
@dataclass
class Tulu3_en_tag_downsample_refusal(DataModule):
...
def format_dataset(dataset: dict, include_multi_turn_conversations: bool) -> List[dict]:
    ...
    with open(refusal_data_path, 'r') as f:
        for line in f:
            ...
            refusal_data.append({"instruction": instruction, "input": "", "output": '<think> Unsafe </think><|endoftext|>' + refusal_response})
    # pick 200
