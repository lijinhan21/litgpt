...
@dataclass
class Tulu3_hint_v1(DataModule):
    ...
    repo_id: str = "/mnt/nodessd/n86/lijinhan/safe_cot_pt/data/Tulu3_hint_v1/final_dataset_merged" 
...
if __name__ == '__main__':
    data_path = '/mnt/nodessd/n86/lijinhan/safe_cot_pt/data/Tulu3_hint_v1/final_dataset_merged'
    from datasets import load_dataset, load_from_disk
