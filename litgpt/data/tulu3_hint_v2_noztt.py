...
@dataclass
class Tulu3_hint_v2_nozttnoise(DataModule):
...
def post_process_text(text):
    ...
    # augmented_text2 = add_if_too_long(augmented_text1, add_ztt_noise, p=0.0)
    ...
    for entry in dataset:
        ...
        if include_multi_turn_conversations:
            ...
            for i in range(num):
                ...
                formatted_ds.append({"instruction": part1, "input": "", "output": part2 + ' ' + entry['processed_text'][i]})
